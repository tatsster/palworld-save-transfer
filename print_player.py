...
of your save folder before continuing. Press enter if you would like to continue.')
    ...
    for i in range(instance_ids_len):
        ...
        if instance_id == old_instance_id:
            ...
            player = old_level_json["root"]["properties"]["worldSaveData"]["Struct"]["value"]["Struct"]["CharacterSaveParameterMap"][
                "Map"]["value"][i]
            with open("playerData.json", 'w') as f:
                json.dump(player, f, indent=2)
            # old_level_json["root"]["properties"]["worldSaveData"]["Struct"]["value"]["Struct"]["CharacterSaveParameterMap"][
